  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Nova conta",style: TextStyle(fontWeight: FontWeight.w600),),
              ...
              Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: ()async{
                      ...
                      if(_editName.text.isNotEmpty && _editEmail.text.isNotEmpty &&_editConfirmPassword.text.isNotEmpty && _editPassword.text.isNotEmpty && _editPassword.text == _editConfirmPassword.text){
                        ...
                        body: json.encode({
                          ...
                          "edit_email" : _editEmail.text,
                          "edit_pass" : _editPassword.text,
                          "edit_Cpass" : _editConfirmPassword.text
                        }));
